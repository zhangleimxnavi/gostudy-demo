...
import (
	"fmt"
	verflag "github.com/marmotedu/gopractise-demo/pflag/vflag"
...
func main() {
	...
	myFlagSet := pflag.NewFlagSet("myFlagset", pflag.ExitOnError)

	//Go 包的初始化次序 : “常量 -> 变量 -> init 函数”的顺序
	verflag.AddFlags(myFlagSet)
